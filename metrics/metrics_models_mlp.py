...
for nt in tqdm(range(1, 11)):
    ...
    # Define the pipeline path for MLP
    if only_growth_rate:
        pipeline_path = f'/home/b/b381993/DeepFate/models/pipeline_mlp_only_growth_rate_{nt}.pkl'
    else:
        pipeline_path = f'/home/b/b381993/DeepFate/models/pipeline_mlp_{nt}.pkl'
...
if only_growth_rate:
    np.savetxt('pearsonr_list_mlp_only_growth_rate.txt', pearsonr_list, delimiter=',')
    np.savetxt('rmse_list_mlp_only_growth_rate.txt', rmse_list, delimiter=',')
else:
    np.savetxt('pearsonr_list_mlp.txt', pearsonr_list, delimiter=',')
    np.savetxt('rmse_list_mlp.txt', rmse_list, delimiter=',')
