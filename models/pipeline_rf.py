...
if __name__ == '__main__':
    ...
    for nt_eval in range(1, 11):
        ...
        pipeline_rf.fit(train_dataset, y_train)

        # Save the trained pipeline
        joblib.dump(pipeline_rf, f'/home/b/b381993/DeepFate/models/saved_models/pipeline_rf_only_growth_rate_{nt_eval}.pkl')

        # Make predictions
        y_pred = pipeline_rf.predict(test_dataset)
